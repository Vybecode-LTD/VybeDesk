...
namespace VybeDesk.Services.Skills;
...
public sealed class SkillLibraryService : ISkillLibraryService
{
    ...
    private static readonly Regex FmNameRx = new(@"^name:\s*(.*)$", RegexOptions.Compiled);
    private static readonly Regex FmDescRx = new(@"^description:\s*(.*)$", RegexOptions.Compiled);
